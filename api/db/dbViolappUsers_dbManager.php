...
function getConnection() {
	...
	global $db_ViolappUsers_db_Url, $db_ViolappUsers_db_User, $db_ViolappUsers_db_Pass, $db_ViolappUsers_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_ViolappUsers_db_Url.";dbname=".$db_ViolappUsers_db_DbName, $db_ViolappUsers_db_User, $db_ViolappUsers_db_Pass);
